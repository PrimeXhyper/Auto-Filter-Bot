...
API_ID = int(environ.get('API_ID', '37109021'))
API_HASH = environ.get('API_HASH', '4b0fd0f1d3c6cf77591ca2419212c967')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://files.catbox.moe/5i24gn.jpg https://files.catbox.moe/yx2hbs.jpg https://files.catbox.moe/sm62hu.jpg')).split() 
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/mrns9u.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/e215d12bfd4fa2155e90e.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/mrns9u.jpg'))
FSUB_IMG = (environ.get('FSUB_IMG', 'https://i.ibb.co/cShkPjcZ/x.jpg')).split() 

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8561360797 8221559270 7968389767').split()] 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003584104229').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003831792629'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-100'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003795816689'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003831792629')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003831792629') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003262798658') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dByte:dByteRuler@cluster0.b5uso42.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'dbyte-V1')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Anipirate_Request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/DragonByte_Network')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/iFightForU')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/ScriptFlix_Botz')

AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002968887563 -1003732189733") # add multiple channels here, separated by single space
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002968887563')

IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003831792629'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003831792629'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/ScriptFlix_Botz")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ScriptFlix_Botz")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ScriptFlix_Botz")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+Q8-SdhxM4oRmMTJl') 
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003584104229')).split()]
...
URL = "alternative-kathe-thehyper333-eb56e5e6.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "alternative-kathe-thehyper333-eb56e5e6.koyeb.app/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', '𝘚𝘤𝘳𝘪𝘱𝘵𝘍𝘭𝘪𝘹'))
MULTI_CLIENT = False
...
if HAS_SSL:
    URL = "alternative-kathe-thehyper333-eb56e5e6.koyeb.app/".format(FQDN)
else:
    URL = "alternative-kathe-thehyper333-eb56e5e6.koyeb.app/".format(FQDN)
